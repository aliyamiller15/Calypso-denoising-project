...
@hydra.main(config_path="conf", config_name="conf.yaml") #@hydra.main(config_path="conf/conf.yaml")
def main(args):
    try:
        _main(args)
    except Exception:
...
#python inference.py inference.audio="C:\Users\Aliya\OneDrive\Documents\Audacity\Official10dB_Noisy_The_Home_Team_Worthy.wav"

#python inference.py inference.audio="C:\Users\Aliya\OneDrive\Desktop\3020 Project\Official3dB_Noisy_Chopin_Nocturne.wav"
